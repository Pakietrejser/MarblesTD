...
namespace MarblesTD.Towers.ShadowPawImpl
{
    public class ShadowPaw : Tower
    {
        public ShadowPaw(SettingsBase settings, ITowerView view, Vector2 position) : base(view, position, settings.GetUpgrades())
        {
